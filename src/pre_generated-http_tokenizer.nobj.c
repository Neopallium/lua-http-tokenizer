...
#define obj_type_id_http_tokenizer 0
#define obj_type_http_tokenizer (obj_types[obj_type_id_http_tokenizer])
  { NULL, 0, OBJ_TYPE_FLAG_WEAK_REF, "http_tokenizer" },
  {NULL, -1, 0, NULL},
};
...
#define obj_type_http_tokenizer_check(L, _index) \
	obj_udata_luacheck(L, _index, &(obj_type_http_tokenizer))
#define obj_type_http_tokenizer_optional(L, _index) \
	obj_udata_luaoptional(L, _index, &(obj_type_http_tokenizer))
#define obj_type_http_tokenizer_delete(L, _index, flags) \
	obj_udata_luadelete_weak(L, _index, &(obj_type_http_tokenizer), flags)
#define obj_type_http_tokenizer_push(L, obj, flags) \
	obj_udata_luapush_weak(L, (void *)obj, &(obj_type_http_tokenizer), flags)
...
"\n"
"const http_token * http_tokenizer_get_tokens(http_tokenizer *);\n"
"\n"
"uint32_t http_tokenizer_count_tokens(http_tokenizer *);\n"
"\n"
"bool http_tokenizer_should_keep_alive(http_tokenizer *);\n"
"\n"
"bool http_tokenizer_is_upgrade(http_tokenizer *);\n"
"\n"
"int http_tokenizer_method(http_tokenizer *);\n"
"\n"
"const char * http_tokenizer_method_str(http_tokenizer *);\n"
"\n"
...
"\n"
"const char * http_tokenizer_error_name(http_tokenizer *);\n"
"\n"
"const char * http_tokenizer_error_description(http_tokenizer *);\n"
"\n"
...
"\n"
"\n"
"local obj_type_http_tokenizer_check\n"
"local obj_type_http_tokenizer_delete\n"
"local obj_type_http_tokenizer_push\n"
"\n"
"do\n"
"	local obj_mt, obj_type, obj_ctype = obj_register_ctype(\"http_tokenizer\", \"http_tokenizer *\")\n"
"\n"
...
"	_priv[obj_type] = obj_type_http_tokenizer_check\n"
...
"	obj_mt.c_check = obj_type_http_tokenizer_check\n"
"	obj_mt.ffi_check = obj_type_http_tokenizer_check\n"
"end\n"
"\n"
"\n"
...
"\n"
"-- method: execute\n"
"function _meth.http_tokenizer.execute(self, cbs, data)\n"
"  \n"
"  local data_len = #data\n"
"  local parsed_len = 0\n"
"  local nparsed = 0\n"
...
"function _meth.http_tokenizer.execute_buffer(self, cbs, buf)\n"
"  \n"
...
"  \n"
"  local rc_http_tokenizer_should_keep_alive = 0\n"
...
"  \n"
"  local rc_http_tokenizer_is_upgrade = 0\n"
...
"  \n"
"  local rc_http_tokenizer_method = 0\n"
...
"  \n"
"  local rc_http_tokenizer_version = 0\n"
...
"  \n"
"  local rc_http_tokenizer_status_code = 0\n"
...
"  \n"
"  local rc_http_tokenizer_error = 0\n"
...
"  return rc_http_tokenizer_error_name ~= nil and ffi_string(rc_http_tokenizer_error_name) or nil\n"
"end\n"
"\n"
...
"  return rc_http_tokenizer_error_description ~= nil and ffi_string(rc_http_tokenizer_error_description) or nil\n"
"end\n"
"\n"
...
"-- method: request\n"
"function _M.request()\n"
"  local rc_http_tokenizer_new_request_flags = OBJ_UDATA_FLAG_OWN\n"
"  local rc_http_tokenizer_new_request\n"
...
"  local rc_http_tokenizer_new_response\n"
...
/* method: _priv */
static int http_tokenizer__delete__meth(lua_State *L) {
  int this_flags = 0;
  http_tokenizer * this;
  this = obj_type_http_tokenizer_delete(L,1,&(this_flags));
...
/* method: reset */
static int http_tokenizer__reset__meth(lua_State *L) {
  http_tokenizer * this;
  this = obj_type_http_tokenizer_check(L,1);
  http_tokenizer_reset(this);
  return 0;
}

/* method: execute */
static int http_tokenizer__execute__meth(lua_State *L) {
  http_tokenizer * this;
  size_t data_len;
  const char * data;
...
/* method: execute_buffer */
static int http_tokenizer__execute_buffer__meth(lua_State *L) {
  http_tokenizer * this;
  BufferIF_VAR(buf);
  uint32_t parsed_len = 0;
  uint32_t nparsed = 0;
...
static int http_tokenizer__should_keep_alive__meth(lua_State *L) {
  http_tokenizer * this;
  bool rc_http_tokenizer_should_keep_alive = 0;
  this = obj_type_http_tokenizer_check(L,1);
  rc_http_tokenizer_should_keep_alive = http_tokenizer_should_keep_alive(this);
  lua_pushboolean(L, rc_http_tokenizer_should_keep_alive);
  return 1;
}

/* method: is_upgrade */
static int http_tokenizer__is_upgrade__meth(lua_State *L) {
  http_tokenizer * this;
  bool rc_http_tokenizer_is_upgrade = 0;
  this = obj_type_http_tokenizer_check(L,1);
  rc_http_tokenizer_is_upgrade = http_tokenizer_is_upgrade(this);
  lua_pushboolean(L, rc_http_tokenizer_is_upgrade);
  return 1;
}

/* method: method */
static int http_tokenizer__method__meth(lua_State *L) {
  http_tokenizer * this;
  int rc_http_tokenizer_method = 0;
  this = obj_type_http_tokenizer_check(L,1);
  rc_http_tokenizer_method = http_tokenizer_method(this);
  lua_pushinteger(L, rc_http_tokenizer_method);
  return 1;
}

/* method: method_str */
static int http_tokenizer__method_str__meth(lua_State *L) {
  http_tokenizer * this;
  const char * rc_http_tokenizer_method_str = NULL;
  this = obj_type_http_tokenizer_check(L,1);
  rc_http_tokenizer_method_str = http_tokenizer_method_str(this);
  lua_pushstring(L, rc_http_tokenizer_method_str);
  return 1;
}

/* method: version */
static int http_tokenizer__version__meth(lua_State *L) {
  http_tokenizer * this;
  int rc_http_tokenizer_version = 0;
  this = obj_type_http_tokenizer_check(L,1);
  rc_http_tokenizer_version = http_tokenizer_version(this);
  lua_pushinteger(L, rc_http_tokenizer_version);
  return 1;
}

/* method: status_code */
static int http_tokenizer__status_code__meth(lua_State *L) {
  http_tokenizer * this;
  int rc_http_tokenizer_status_code = 0;
  this = obj_type_http_tokenizer_check(L,1);
  rc_http_tokenizer_status_code = http_tokenizer_status_code(this);
  lua_pushinteger(L, rc_http_tokenizer_status_code);
  return 1;
}
...
static int http_tokenizer__error__meth(lua_State *L) {
  http_tokenizer * this;
  int rc_http_tokenizer_error = 0;
  this = obj_type_http_tokenizer_check(L,1);
  rc_http_tokenizer_error = http_tokenizer_error(this);
  lua_pushinteger(L, rc_http_tokenizer_error);
  return 1;
}

/* method: error_name */
static int http_tokenizer__error_name__meth(lua_State *L) {
  http_tokenizer * this;
  const char * rc_http_tokenizer_error_name = NULL;
  this = obj_type_http_tokenizer_check(L,1);
  rc_http_tokenizer_error_name = http_tokenizer_error_name(this);
  lua_pushstring(L, rc_http_tokenizer_error_name);
  return 1;
}

/* method: error_description */
static int http_tokenizer__error_description__meth(lua_State *L) {
  http_tokenizer * this;
  const char * rc_http_tokenizer_error_description = NULL;
  this = obj_type_http_tokenizer_check(L,1);
  rc_http_tokenizer_error_description = http_tokenizer_error_description(this);
  lua_pushstring(L, rc_http_tokenizer_error_description);
  return 1;
}

/* method: request */
static int http_tokenizer__request__func(lua_State *L) {
  int rc_http_tokenizer_new_request_flags = OBJ_UDATA_FLAG_OWN;
  http_tokenizer * rc_http_tokenizer_new_request;
  rc_http_tokenizer_new_request = http_tokenizer_new_request();
  obj_type_http_tokenizer_push(L, rc_http_tokenizer_new_request, rc_http_tokenizer_new_request_flags);
  return 1;
}

/* method: response */
static int http_tokenizer__response__func(lua_State *L) {
  int rc_http_tokenizer_new_response_flags = OBJ_UDATA_FLAG_OWN;
  http_tokenizer * rc_http_tokenizer_new_response;
  rc_http_tokenizer_new_response = http_tokenizer_new_response();
  obj_type_http_tokenizer_push(L, rc_http_tokenizer_new_response, rc_http_tokenizer_new_response_flags);
  return 1;
}



static const luaL_Reg obj_http_tokenizer_pub_funcs[] = {
  {NULL, NULL}
};

static const luaL_Reg obj_http_tokenizer_methods[] = {
...
static const luaL_Reg obj_http_tokenizer_metas[] = {
  {"__gc", http_tokenizer__delete__meth},
  {"__tostring", obj_udata_default_tostring},
  {"__eq", obj_udata_default_equal},
  {NULL, NULL}
};

static const obj_base obj_http_tokenizer_bases[] = {
  {-1, NULL}
};

static const obj_field obj_http_tokenizer_fields[] = {
  {NULL, 0, 0, 0}
};

static const obj_const obj_http_tokenizer_constants[] = {
  {NULL, NULL, 0.0 , 0}
};

static const reg_impl obj_http_tokenizer_implements[] = {
  {NULL, NULL}
};

static const luaL_Reg http_tokenizer_function[] = {
  {"request", http_tokenizer__request__func},
  {"response", http_tokenizer__response__func},
  {NULL, NULL}
};

static const obj_const http_tokenizer_constants[] = {
#ifdef HTTP_TOKEN_HEADER_FIELD
  {"HTTP_TOKEN_HEADER_FIELD", NULL, HTTP_TOKEN_HEADER_FIELD, CONST_NUMBER},
#endif
#ifdef HTTP_TOKEN_HEADERS_COMPLETE
  {"HTTP_TOKEN_HEADERS_COMPLETE", NULL, HTTP_TOKEN_HEADERS_COMPLETE, CONST_NUMBER},
#endif
#ifdef HTTP_TOKEN_MESSAGE_COMPLETE
  {"HTTP_TOKEN_MESSAGE_COMPLETE", NULL, HTTP_TOKEN_MESSAGE_COMPLETE, CONST_NUMBER},
#endif
#ifdef HTTP_TOKEN_MESSAGE_BEGIN
  {"HTTP_TOKEN_MESSAGE_BEGIN", NULL, HTTP_TOKEN_MESSAGE_BEGIN, CONST_NUMBER},
#endif
#ifdef HTTP_TOKEN_HEADER_VALUE
  {"HTTP_TOKEN_HEADER_VALUE", NULL, HTTP_TOKEN_HEADER_VALUE, CONST_NUMBER},
#endif
#ifdef HTTP_TOKEN_BODY
  {"HTTP_TOKEN_BODY", NULL, HTTP_TOKEN_BODY, CONST_NUMBER},
#endif
#ifdef HTTP_TOKEN_URL
  {"HTTP_TOKEN_URL", NULL, HTTP_TOKEN_URL, CONST_NUMBER},
#endif
  {NULL, NULL, 0.0 , 0}
};
...
static const reg_sub_module reg_sub_modules[] = {
  { &(obj_type_http_tokenizer), REG_OBJECT, obj_http_tokenizer_pub_funcs, obj_http_tokenizer_methods, obj_http_tokenizer_metas, obj_http_tokenizer_bases, obj_http_tokenizer_fields, obj_http_tokenizer_constants, obj_http_tokenizer_implements, 0},
...
LUA_NOBJ_API int luaopen_http_tokenizer(lua_State *L) {
...
#else
	lua_newtable(L);
	luaL_setfuncs(L, http_tokenizer_function, 0);
#endif
	...
	if(nobj_check_ffi_support(L)) {
		nobj_try_loading_ffi(L, "http_tokenizer.nobj.ffi.lua", http_tokenizer_ffi_lua_code,
			http_tokenizer_ffi_export, priv_table);
	}
#endif
